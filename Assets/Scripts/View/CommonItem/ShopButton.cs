...
namespace View.CommonItem
{
    public class ShopButton : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            val_13 = null;
            val_13 = null;
            val_15 = ShopButton.<>c.<>9__5_0;
            if(val_15 == null)
            {
                    UnityEngine.Events.UnityAction val_12 = null;
                val_15 = val_12;
                val_12 = new UnityEngine.Events.UnityAction(object:  ShopButton.<>c.__il2cppRuntimeField_static_fields, method:  System.Void ShopButton.<>c::<Awake>b__5_0());
                ShopButton.<>c.<>9__5_0 = val_15;
            }
        ...
        {
            this.effectGain.gameObject.SetActive(value:  false);
            Message.Messager.Add(cmd:  23, action:  new System.Action(object:  this, method:  System.Void View.CommonItem.ShopButton::GetCoinIconPosition()));
            Message.Messager.Add(cmd:  78, action:  new System.Action(object:  this, method:  System.Void View.CommonItem.ShopButton::CoinChangeNotify()));
        }
        private void OnDisable()
        {
            Message.Messager.Remove(cmd:  23, action:  new System.Action(object:  this, method:  System.Void View.CommonItem.ShopButton::GetCoinIconPosition()));
            Message.Messager.Remove(cmd:  78, action:  new System.Action(object:  this, method:  System.Void View.CommonItem.ShopButton::CoinChangeNotify()));
        }
        public ShopButton()
        {
