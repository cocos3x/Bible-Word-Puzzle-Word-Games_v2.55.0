...
namespace Utils.Util.Time
{
    public class DateUtil
    {
        ...
        // Methods
        public static long CurrentTimeMillis(System.Nullable<System.DateTime> dateTime, bool useUtc = False)
        {
            ulong val_6;
            var val_7;
            ulong val_8;
            ...
            if((useUtc & true) == 0)
            {
                    System.DateTime val_1 = dateTime.HasValue.Value;
                val_6 = val_1.dateData;
                if((W2 & 1) != 0)
            {
                    System.DateTime val_2 = val_6.ToUniversalTime();
                ...
                val_7 = null;
                val_8 = val_6;
                val_9 = Utils.Util.Time.DateUtil.defaultDateTime;
            }
            else
            {
            ...
            System.TimeSpan val_4 = System.DateTime.op_Subtraction(d1:  new System.DateTime() {dateData = val_8}, d2:  new System.DateTime() {dateData = val_9});
            return (long)(long)val_4._ticks.TotalMilliseconds;
        }
        public static System.DateTime GetDateTime(string dateString, string format)
        {
            return Utils.Util.Time.DateUtil.GetDateTime(dateString:  dateString, format:  format, provider:  System.Globalization.CultureInfo.InvariantCulture);
        }
        public static System.DateTime GetDateTime(string dateString, string format, System.IFormatProvider provider)
        {
            ...
            goto label_4;
            label_1:
            string val_2 = Utils.Util.Time.DateUtil.FixDateString(dateString:  val_7);
            val_7 = val_2;
            ...
            val_10 = null;
            label_4:
            val_11 = Utils.Util.Time.DateUtil.defaultDateTime;
            ...
            if((System.String.IsNullOrEmpty(value:  val_6)) != false)
            {
                    val_12 = null;
                val_12 = null;
                val_6 = Utils.Util.Time.DateUtil.defaultDateFormat;
            }
        ...
        {
            return Utils.Util.Time.DateUtil.GetDateString(dateTime:  new System.DateTime() {dateData = dateTime.dateData}, format:  format, provider:  System.Globalization.CultureInfo.InvariantCulture);
        }
        public static string GetDateString(System.DateTime dateTime, string format, System.IFormatProvider provider)
        {
            ...
            val_3 = null;
            val_3 = null;
            return (string)dateTime.dateData.ToString(format:  Utils.Util.Time.DateUtil.defaultDateFormat, provider:  provider);
        }
        public static System.TimeSpan GetTimeSpan(string timeSpanString)
        {
            int val_8;
            var val_9;
            System.TimeSpan val_10;
            string val_11;
            if((System.String.IsNullOrEmpty(value:  timeSpanString)) != false)
            {
                    val_8 = 1152921504619253760;
                val_9 = null;
                val_9 = null;
            ...
            System.String[] val_3 = timeSpanString.Split(separator:  val_2);
            if(val_3.Length == 0)
            {
                    throw new IndexOutOfRangeException();
            }
            ...
            val_8 = System.Int32.Parse(s:  val_11);
            System.TimeSpan val_7 = new System.TimeSpan(hours:  val_8, minutes:  System.Int32.Parse(s:  val_3[1]), seconds:  System.Int32.Parse(s:  val_3[2]));
            val_10 = val_7._ticks;
            return (System.TimeSpan)val_10;
        }
        public static string GetTimeSpanString(System.TimeSpan timeSpan)
        {
            return (string)System.String.Format(format:  "{0:00}:{1:00}:{2:00}", arg0:  timeSpan._ticks.Hours, arg1:  timeSpan._ticks.Minutes, arg2:  timeSpan._ticks.Seconds);
        }
        ...
        private static string FixDateString(string dateString)
        {
            ...
            int val_1 = 0;
            System.Int32[] val_2 = Utils.Util.Time.DateUtil.getTimeInfoFromString(strTime:  val_5 = dateString, timeInfoIndex: ref  val_1);
            if(val_2 != null)
            {
                    if(val_1 > 5)
            {
        ...
        {
            Utils.Util.Time.DateUtil.defaultDateFormat = "yyyy-MM-dd HH:mm:ss";
            System.DateTime val_1 = new System.DateTime(year:  178, month:  1, day:  1, hour:  0, minute:  0, second:  0, kind:  1);
            Utils.Util.Time.DateUtil.defaultDateTime = val_1.dateData;
        }
