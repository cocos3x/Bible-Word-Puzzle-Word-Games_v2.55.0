...
namespace Utils.Util.Line
{
    public class LineUtil
    {
        // Methods
        public static UnityEngine.Vector3[] GetSmoothPoints(UnityEngine.Vector3[] points, int smooth = 10)
        {
            ...
            if(points.Length < 3)
            {
                    return (UnityEngine.Vector3[])val_5;
            }
            
            val_8 = points.Length * val_8;
            val_4 = Utils.Util.Line.LineUtil.PathControlPointGenerator(path:  val_5);
            val_5 = new UnityEngine.Vector3[0];
            if(val_8 >= 1)
            {
                    var val_10 = 1;
                do
            {
                ...
                UnityEngine.Vector3 val_3 = Utils.Util.Line.LineUtil.Interp(pts:  val_4, t:  val_9);
                val_10 = ((long)val_10 - 1) + 2;
                var val_5 = val_5 + (((long)val_10 - 1) * 12);
                mem2[0] = val_3.x;
                mem2[0] = val_3.y;
                mem2[0] = val_3.z;
            }
        ...
        public static UnityEngine.Vector3[] GetBezierList(UnityEngine.Vector3 startPoint, UnityEngine.Vector3 controlPoint, UnityEngine.Vector3 endPoint, int segmentNum)
        {
            ...
            do
            {
                ...
                UnityEngine.Vector3 val_3 = Utils.Util.Line.LineUtil.CalculateCubicBezierPoint(t:  val_6, p0:  new UnityEngine.Vector3() {x = startPoint.x, y = startPoint.y, z = startPoint.z}, p1:  new UnityEngine.Vector3() {x = controlPoint.x, y = controlPoint.y, z = controlPoint.z}, p2:  new UnityEngine.Vector3() {x = endPoint.x, y = endPoint.y});
